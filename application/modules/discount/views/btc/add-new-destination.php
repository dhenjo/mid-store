    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_tiket_discount_destination))?>
              <div class="box-body">
                ...
                <div class="control-group">
                  ...
                  <?php print $this->form_eksternal->form_input('destinationcode', $detail[0]->destinationcode, 'class="form-control input-sm" placeholder="Destination"');?>
                </div>
