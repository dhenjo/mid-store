    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', 
                    array("id_detail" => $detail[0]->id_store_region))?>
              <div class="box-body">
                ...
                <div class="control-group">
                  ...
                  <?php print $this->form_eksternal->form_dropdown('master', array(2 => "Master Tour"),array($detail[0]->master), 'class="form-control input-sm"');?>
                </div>
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("store/master-store-region")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->